    ...
    <div className=''>
        ...
        <div className=' grid  mx-5 md:mx-10  sm:grid-cols-2  md:grid-cols-2 lg:grid-cols-4 gap-5 xl:gap-10'>
            ...
            <div className='  flex justify-center flex-col items-center  '>
                <img src={chef1} alt="stew" className=' rounded-3xl hover:shadow-lg w-72 h-72 sm:h-80 object-cover'/>
                <div className='text-xl text-center font-bold  my-5'>Maria Sadma</div>
            </div>

            <div className='flex justify-center flex-col items-center'>
                <img src={chef2} alt="stew" className=' rounded-3xl hover:shadow-lg w-72 h-72 sm:h-80 object-cover'/>
                <div className='text-xl text-center font-bold  my-5 '>Jesa Mark</div>
            </div>

            <div className='flex justify-center flex-col items-center'>
                <img src={chef3} alt="stew" className='  rounded-3xl hover:shadow-lg w-72 h-72 sm:h-80 object-cover'/>
                <div className='text-xl text-center font-bold  my-5 '>Mario Dennis </div>
            </div>
            
            <div className='flex justify-center flex-col items-center '>
                <img src={chef4} alt="stew" className='   rounded-3xl hover:shadow-lg w-72 h-72 sm:h-80  object-fill '/>
